...
import {getSelectedNode} from "../../utils/getSelectNode.js";
import {getDomRange} from "../../utils/getDomRange.js";
import {setFloatingElement} from "../../utils/setFloatingElement.js";
import {Box, IconButton} from "@mui/material";
import {
  Code,
  FormatBoldOutlined,
  FormatItalicOutlined,
  FormatUnderlinedOutlined, InsertLinkOutlined,
...
function TextFormatFloatingToolbar({
  ...
  const updateTextFormatFloatingToolbar = useCallback(() => {
    ...
    if (
      ...
      const rangeRect = getDomRange(nativeSelection, rootElement);

      setFloatingElement(rangeRect, popupCharStylesEditorElem, anchorElem);
    }
  }, [editor, anchorElem]);
