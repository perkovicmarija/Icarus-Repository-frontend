...
import { Table, TableBody, TableHead, TableRow, TableCell, IconButton, Tooltip } from '@mui/material';
...
class Attachments extends Component {
    ...
    render() {
        const {classes, attachments, editDisabled, onAttachDownload, onAttachDelete} = this.props;
        ...
        return (
            <div>
                ...
                <Table>
                    <TableHead>
                        <TableRow>
                            <TableCell padding="none"><IntlMessages id="general.filename"/></TableCell>
                            <TableCell><IntlMessages id="general.description"/></TableCell>
                            <TableCell classes={{root: classes.thActions}}
                                       key="Actions"
                                       padding="default">
