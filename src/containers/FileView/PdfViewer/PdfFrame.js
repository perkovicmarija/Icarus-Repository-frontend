                    ...
                    <div id="mainContainer">
                        <div className={findBarClassName} id="findbar">
                            ...
                            <div id="findbarOptionsOneContainer">
                                ...
                                <input type="checkbox" id="findMatchCase" className="toolbarField" tabIndex="95" checked={findMatchCase} onChange={this.onCheckboxChange}/>
                                <label htmlFor="findMatchCase" className="toolbarLabel"
                                       data-l10n-id="find_match_case_label">Match case</label>
                            </div>
                            <div id="findbarOptionsTwoContainer">
                                <input type="checkbox" id="findEntireWord" className="toolbarField" tabIndex="96" checked={findWholeWords} onChange={this.onCheckboxChange}/>
