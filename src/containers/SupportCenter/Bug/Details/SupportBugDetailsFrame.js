...
import { getSupportBugAttachmentsPath, getSupportBugCommentsPath } from "../../../../consts/routePaths";
...
function SupportBugDetailsFrame(props) {
    ...
    const handleInputIcarusBugChange = (name, event) => {
        let supportBugClone = cloneDeep(supportBug);
        supportBugClone[name] = event.target.value;
    ...
    const {modules, levels, statuses, progress, progressBarOpened, supportBugId} = props;
        ...
        <React.Fragment>
            <Paper className={classes.root}>
                <FormTitleSubtitleBarSupport
                    title="support.item"
                    subtitle={supportBug.supportBugIdSign ? supportBug.supportBugIdSign : "N/A"}
                ...
                <Grid container spacing={2} className={classes.infoBlock}>
                    <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                        <Grid container spacing={2}>
                            <Grid item xl={4} lg={4} md={4} sm={4} xs={12} className={classes.whiteColor}>
                                <span><strong><IntlMessages
                                    id="general.createdBy"/>:</strong> {supportBug.userAuthor ? supportBug.userAuthor.fullName : "N/A"}</span>
                            </Grid>
                            <Grid item xl={4} lg={4} md={4} sm={4} xs={12} className={classes.whiteColor}>
                                <span><strong><IntlMessages id="general.created"/>:</strong> {supportBug.created}</span>
                            </Grid>
                            <Grid item xl={4} lg={4} md={4} sm={4} xs={12} className={classes.whiteColor}>
                                <span><strong><IntlMessages id="general.status"/>:</strong>
                                    <span
                                        className={changeValueOnStatus(supportBug.status ? supportBug.status.code : "N/A")}> {supportBug.status ? supportBug.status.status : "N/A"}</span>
                                </span>
                            </Grid>
                        </Grid>
                    </Grid>
                    <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                        <Grid container spacing={2}>
                            <Grid item xl={4} lg={4} md={4} sm={4} xs={12} className={classes.whiteColor}>
                                <span><strong><IntlMessages
                                    id="support.severity"/>:</strong> {supportBug.level ? supportBug.level.level : "N/A"}</span>
                            </Grid>
                            <Grid item xl={4} lg={4} md={4} sm={4} xs={12} className={classes.whiteColor}>
                                <span><strong><IntlMessages id="general.dueDate"/>:</strong> {supportBug.dueDate}</span>
                            </Grid>
                    ...
                    <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                        <Grid container spacing={2}>
                            <Grid item xl={4} lg={4} md={4} sm={4} xs={12} className={classes.whiteColor}>
                                <span><strong><IntlMessages
                                    id="support.module"/>:</strong> {supportBug.module ? supportBug.module.name : "N/A"}</span>
                            </Grid>
                            <Grid item xl={4} lg={4} md={4} sm={4} xs={12} className={classes.whiteColor}>
                                <span><strong><IntlMessages
                                    id="general.closedOnDate"/>:</strong> {supportBug.closed ? supportBug.closed : "N/A"}</span>
                            </Grid>
                ...
                <AppBar position="static" color="default">
                    ...
                    >
                        <Tab label={<IntlMessages id="general.comments"/>} className={classes.tabLink} component={Link}
                             to={getSupportBugCommentsPath(supportBugId)}/>
                        <Tab label={<IntlMessages id="attachments.label"/>} className={classes.tabLink} component={Link}
...
export default (connect(mapStateToProps, mapDispatchToProps)(SupportBugDetailsFrame));