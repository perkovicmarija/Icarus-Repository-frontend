...
function SupportBugComments(props) {
    ...
    const handleInputChange = (name, event) => {
        ...
        newCommentClone[name] = event.target.value;
                            ...
                            {supportBug.comments.map(item => {
                                return (
                                    <TableRow
                                        ...
                                        <TableCell
                                            className={classes.tableData}>{item.userAuthor.fullName}</TableCell>
                                        <TableCell className={classes.tableData}>{item.created}</TableCell>
                                        {item.automaticMessage ?
                                            <TableCell className={classes.commentRow}><p>
                                                <strong>{item.comment}</strong></p>
                                            </TableCell>
                                            :
                                            <TableCell className={classes.commentRow}><p>{item.comment}</p>
                                            </TableCell>
                                        }
