...
function DocumentationFolderPath({
  classes,
  currentPath,
  onDocumentationFolderRootClick,
  onDocumentationFolderPathClick,
}) {
  const documentationFolderPath = currentPath.split("/");

  return (
    <div className={classes.root}>
      <Button
        className={classes.folderName}
        onClick={onDocumentationFolderRootClick}
      >
      ...
      {documentationFolderPath.map((folder, index) => {
        return (
          <span className="centerParent" key={index}>
            <Button
              className={classes.folderName}
              onClick={(event) => onDocumentationFolderPathClick(folder)}
            >
              {folder.folderName}
            </Button>
