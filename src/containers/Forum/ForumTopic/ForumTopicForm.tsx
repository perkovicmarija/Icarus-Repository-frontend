      ...
      <Grid item xs={12}>
        <form
          onSubmit={(e) => {
            ...
            handleSubmit((data) => {
              setLoading(true);
              onForumTopicSubmit(data as ForumTopic)
            ...
            <Grid item xl={6} lg={6} md={12} sm={12} xs={12}>
              <StyledPaper style={{padding: "5rem"}}>
                ...
                <div style={{display: 'flex', alignItems: 'center'}}>
                  <h4><IntlMessages id="forum.user"/>:&nbsp;</h4><span>{forumUser?.displayName}</span>
                </div>
              </StyledPaper>
            </Grid>
            ...
            {forumTopicId != "-1" &&
              <Grid item xs={12} style={{display: "flex", alignItems: "center"}}>
                <div onClick={() => onTopicLike()}
                  ...
                  {forumTopic.forumLikes.find((like) => like.forumUserCreatedDisplayName === forumUser?.displayName) ? (
